...
using mvp_frame_wpf.Main.Properties;
using mvp_frame_wpf.Main.ViewModels;
using mvp_frame_wpf.Main.Views;
using mvp_frame_wpf.Modules.ViewModels;
using mvp_frame_wpf.Modules.Views;
using System.ComponentModel;
using System.Windows;
using AppModules = mvp_frame_wpf.Common.Modules;

namespace mvp_frame_wpf.Main
{
